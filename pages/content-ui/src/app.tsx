...
export default function App() {
  ...
  const handleMouseMove = MouseEventThrottle((e: MouseEvent) => {
    if (updateMousePosition(e) && product.current !== null) {
  ...
  return (
    ...
    console.log('Error in App: Please reload the page.', error);
    return null;
  }
}